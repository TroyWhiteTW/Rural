...
public class HouseActivity extends AppCompatActivity implements LocationListener {
    private Toolbar toolbar;

    private TabLayout mTabs;

    private ScrollView sc;
    private TextView tt, ta, ti, txt_r1, txt_r2, txt_r3, txt_r4;
    private WebView webView;
    private LocationManager lmgr;
    double ulat, ulng;

    int _id, fav;
    String page, name, introduction, lat, lon, address, phone;
...
//        mDrawerLayout.setDrawerListener(mActionBarDrawerToggle);
    ...
    private void addFav(){
        ...
        SQLiteOpenHelper mDBHelper = new DBHelper(HouseActivity.this);
        try {
